...
$libs = array(
        array('lib' => 'frood', 'url' => 'http://github.com/Ibmurai/frood.git',
                'ver' => '1.2.1'),
        array('lib' => 'froodTwig',
                'url' => 'http://github.com/akimsko/froodTwig.git',
                'ver' => 'v.1.0'),
        array('lib' => 'PHP-Daemon',
                'url' => 'https://github.com/akimsko/PHP-Daemon.git',
                'ver' => 'vigu'),
        array('lib' => 'php-gearman-admin',
...
foreach ($libs as $lib) {
    ...
    if (!is_dir($installPath)) {
        ...
        system(
                'git clone ' . escapeshellarg($lib['url']) . ' '
    ...
    system(
            'cd ' . escapeshellarg($installPath)
                    . ' && git fetch origin && git reset --hard '
                    . escapeshellarg($lib['ver']));
