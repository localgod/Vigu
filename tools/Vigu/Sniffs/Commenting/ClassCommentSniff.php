...
if (class_exists('Vigu_Sniffs_Commenting_FileCommentSniff', true) === false) {
	$error = 'Class Vigu_Sniffs_Commenting_FileCommentSniff not found';
	throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Vigu_Sniffs_Commenting_ClassCommentSniff extends Vigu_Sniffs_Commenting_FileCommentSniff {
